    ...
    <ActionForm action={createCompletedTaskAction} className="mt-6 space-y-4 rounded-2xl border border-[#d7dfcf] bg-[#fffef9] p-4 shadow-[0_2px_0_#d7dfcf]">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="text-sm font-semibold">
          Titel
          <input className="mt-1 w-full rounded-xl border border-[#cbd8c1] px-3 py-3" name="title" placeholder="Rasenmaehen" required />
        </label>
        <label className="text-sm font-semibold">
          Erledigt von
          <select className="mt-1 w-full rounded-xl border border-[#cbd8c1] bg-white px-3 py-3" name="completed_by" required>
            {members.map((member) => (
        ...
        <label className="text-sm font-semibold">
          Erledigt am
          <input className="mt-1 w-full rounded-xl border border-[#cbd8c1] px-3 py-3" name="completed_on" required type="date" />
        </label>
        <label className="text-sm font-semibold">
          Punkte
          <select className="mt-1 w-full rounded-xl border border-[#cbd8c1] bg-white px-3 py-3" name="points" defaultValue="4">
            {[1, 2, 3, 4, 5].map((point) => (
