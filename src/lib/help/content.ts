...
export const helpItems: HelpItem[] = [
  ...
  },
  {
    ...
    note: "Owner-Rechte vergeben oder entziehen koennen nur Owner. Der letzte Owner kann nicht herabgestuft werden.",
  },
  {
    role: "Owner",
    topic: "Mitglieder",
    title: "Owner-Rolle uebergeben",
    location: "Mehr > Mitglieder",
    keywords: ["owner", "uebergeben", "nachfolger", "hauptverantwortlich"],
    steps: [
      "Zuerst die neue Person zum Owner machen.",
      "Danach die eigene Rolle auf Admin oder Mitglied setzen.",
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      "Bestaetigen. Alle Dienste, Punkte, Chats und Abrechnungen werden endgueltig geloescht.",
    ],
  },
];
